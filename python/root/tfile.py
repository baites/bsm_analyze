...
class topen(object):
    '''
    Context manager for ROOT TFile. This way opening/closing file is
    automatically done and 'with' statement can be used for this, e.g.:

        with topen(filname.root) as f:
            pass
    '''
