...
class InputType(BaseType):
    ...
    input_types = {
        ...
        "zprime_m1000_w10": InputData(0.5, 207992),
        "zprime_m1500_w15": InputData(0.5, 168383),
        "zprime_m2000_w20": InputData(0.5, 179315),
        "zprime_m3000_w30": InputData(0.5, 195410),
        "zprime_m4000_w40": InputData(0.5, 180381),
