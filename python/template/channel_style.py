...
class ChannelStyle(BaseStyle):
    ...
    channel_styles = {
            ...
            "data": Style(fill = False),

            "zprime_m1000_w10": Style(line_style = 1, fill = False),
            "zprime_m1500_w15": Style(line_style = 2, fill = False),
            "zprime_m2000_w20": Style(line_style = 3, fill = False),
            "zprime_m3000_w30": Style(line_style = 4, fill = False),
            "zprime_m4000_w40": Style(line_style = 5, fill = False)
            }
