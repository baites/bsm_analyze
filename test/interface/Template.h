...
class Template
{
    public:
        enum Type
        {
            ...
            NPV_NO_PU,
            NJET,
            NJET_BEFORE_RECONSTRUCTION,
            NJET2_DR_LEPTON_JET1_BEFORE_RECONSTRUCTION,
            NJET2_DR_LEPTON_JET2_BEFORE_RECONSTRUCTION,
            NJET_AFTER_RECONSTRUCTION,
            NJET2_DR_LEPTON_JET1_AFTER_RECONSTRUCTION,
            NJET2_DR_LEPTON_JET2_AFTER_RECONSTRUCTION,
            TTBAR_MASS,
            TTBAR_PT,
            WLEP_MT,
            WLEP_MASS,
