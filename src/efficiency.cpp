...
typedef shared_ptr<EfficiencyAnalyzer> AnalyzerPtr;
...
try
{
    EfficiencyAnalyzer::LeptonMode mode = EfficiencyAnalyzer::ELECTRON;
    ...
    // Prepare Analysis
    //
    AnalyzerPtr analyzer(new EfficiencyAnalyzer(mode));

    // Load corrections
    //
    {
        EfficiencyAnalyzer::Corrections corrections;
